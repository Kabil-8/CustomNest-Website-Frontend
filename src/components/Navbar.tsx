                    ...
                    {user ? (
                      <>
                        ...
                        {user.role === 'admin' && (
                          <Link
                            to="/admin"
                            className="flex items-center gap-2.5 px-4 py-2 text-sm hover:bg-rose-50 hover:text-rose-600"
              ...
              <div className="mt-auto px-6 py-6 border-t border-line">
                {user ? (
                  <div className="flex flex-col gap-3">
                    ...
                    <Link to="/account" onClick={() => setMobileOpen(false)} className="btn-secondary w-full">
                      My Account
                    </Link>
                    <button
                      onClick={async () => {
